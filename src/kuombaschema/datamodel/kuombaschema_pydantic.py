...
linkml_meta = LinkMLMeta(
    {
        ...
        "prefixes": {
            ...
            "kuombaschema": {
                "prefix_prefix": "kuombaschema",
                "prefix_reference": "https://w3id.org/acmarkham/KuombaSchema/",
            },
            "linkml": {
        ...
        "see_also": ["https://acmarkham.github.io/KuombaSchema"],
        "source_file": "src/kuombaschema/schema/kuombaschema.yaml",
        "title": "KuombaSchema",
    }
)
...
class NamedThing(ConfiguredBaseModel):
    ...
    name: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["NamedThing"], "slot_uri": "schema:name"}
        },
    )
...
class Person(NamedThing):
    ...
    primary_email: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Person"], "slot_uri": "schema:email"}
        },
    )
    birth_date: Optional[date] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Person"], "slot_uri": "schema:birthDate"}
        },
    )
...
class PersonCollection(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"from_schema": "https://w3id.org/acmarkham/KuombaSchema", "tree_root": True}
    )

    people: Optional[list[Person]] = Field(
        default=None,
        json_schema_extra={"linkml_meta": {"domain_of": ["PersonCollection"]}},
    )
